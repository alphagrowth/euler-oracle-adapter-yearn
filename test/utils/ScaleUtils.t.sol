...
import { ScaleUtilsHarness } from "./ScaleUtilsHarness.sol";
import { Errors } from "../../src/utils/Errors.sol";
import { ScaleUtils, Scale } from "../../src/utils/ScaleUtils.sol";
...
contract ScaleUtilsTest is Test {
    ...
    function test_GetDirectionOrRevert_RevertsWhen_InvalidBaseOrQuote(
        address base,
        address quote,
        address other
    )
    ...
    function test_CalcScale_RevertsWhen_PriceScaleOOB(
        uint8 baseDecimals,
        uint8 quoteDecimals,
        uint8 feedDecimals
    )
    ...
    function test_CalcScale_RevertsWhen_FeedScaleOOB(
        uint8 baseDecimals,
        uint8 quoteDecimals,
        uint8 feedDecimals
    )
